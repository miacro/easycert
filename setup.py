...
version = None
with open('easycert/version.py') as version_file:
...
def get_package_data():
    prev_dir = os.getcwd()
    root_dir = os.path.join(os.path.dirname(abspath), "easycert")
    os.chdir(root_dir)
    result = []
...
setup(name='easycert',
      ...
      scripts=get_scripts(),
      package_data= {'easycert': get_package_data()},
